...
from agents import AgentLoader, load_complete_team, load_market_researcher, load_risk_analysts
...
def example_3_risk_analysts_consensus():
    ...
    portfolio_summary = {"cash": 100.0, "total_equity": 100.0, "roi": 0.0}

    # Load all 3 risk analysts
    print("\n[Loading 3 Risk Analysts...]")
    risk_analysts = load_risk_analysts(use_openrouter=False, portfolio_summary=portfolio_summary)
