...
class TradingSimulator:
    ...
    def execute_buy(self, ticker: str, shares: int, price: float, date: str, reason: str = "") -> Dict:
        """Ejecutar compra"""
        cost = shares * price
    ...
    def execute_sell(self, ticker: str, shares: int, price: float, date: str, reason: str = "") -> Dict:
        """Ejecutar venta"""
...
class BacktestEngine:
    ...
    def __init__(self, tickers: List[str], start_date: str, end_date: str, 
                 decision_interval: int = 5, initial_capital: float = 10000.0):
        """
        Args:
...
"""
    ...
    def run_simulation(self, model_id: str = None, verbose: bool = True):
        ...
        print("="*70)
        print(f"📅 Período: {self.start_date.strftime('%Y-%m-%d')} → {self.end_date.strftime('%Y-%m-%d')}")
        ...
        for i, date in enumerate(decision_dates, 1):
            ...
            print(f"💰 Valor Portfolio: ${portfolio_value:,.2f} | Efectivo: ${self.simulator.cash:,.2f}")
            print(f"{'─'*70}")
