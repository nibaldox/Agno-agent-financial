...
from hourly_backtest import HourlyBacktestEngine, MODELS
...
def main():
    ...
    print(f"  • Decisiones: Cada {decision_interval_hours} hora(s) (~{(days*24)//decision_interval_hours} decisiones)")
