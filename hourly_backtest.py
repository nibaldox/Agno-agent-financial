#!/usr/bin/env python3
"""
Sistema de Backtesting con Datos HORARIOS (1h)
...
- Máximo a invertir por operación: ${max_investment:.2f} (25% del efectivo)
{position_info}

DECISIÓN REQUERIDA (TRADING DE CORTO PLAZO):
Basándote SOLO en datos hasta {timestamp.strftime('%Y-%m-%d %H:%M')}, decide:

RESPONDE EN FORMATO EXACTO (3 LÍNEAS):
ACCION: BUY
MONTO: 2500
RAZON: Momentum alcista en 4h, RSI favorable
...
ACCION: SELL
MONTO: 50
RAZON: [tu razón] (50 = vender 50% de posición)

REGLAS:
- Si ACCION es BUY, MONTO debe ser entre 1000 y {max_investment:.0f}
- Si ACCION es SELL, MONTO debe ser entre 25 y 100 (porcentaje)
- Si ACCION es HOLD, MONTO debe ser 0
