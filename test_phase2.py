...
def create_sample_data():
    ...
    holdings_data = [
        {'ticker': 'AAPL', 'shares': 10, 'buy_price': 150.0, 'current_price': 160.0, 
         'current_value': 1600.0, 'pnl': 100.0, 'roi_percent': 6.67},
        {'ticker': 'MSFT', 'shares': 5, 'buy_price': 300.0, 'current_price': 310.0,
         'current_value': 1550.0, 'pnl': 50.0, 'roi_percent': 3.33},
        {'ticker': 'GOOGL', 'shares': 8, 'buy_price': 140.0, 'current_price': 135.0,
         'current_value': 1080.0, 'pnl': -40.0, 'roi_percent': -3.57}
    ]
...
def test_metrics_calculator():
    ...
    required_keys = [
        'sharpe_annual', 'sortino_annual', 'max_drawdown',
