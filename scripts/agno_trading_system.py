...
def create_market_researcher_agent(provider: str = "deepseek", model: Optional[str] = None) -> Agent:
    """
...
def create_trading_strategist_agent(provider: str = "deepseek", model: Optional[str] = None) -> Agent:
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Agno Multi-Agent Trading System"
    )
    parser.add_argument(
        "--provider",
        type=str,
