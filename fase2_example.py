...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate Phase 2 reports with metrics and visualizations')
    parser.add_argument('--data-dir', type=str, default='Start Your Own',
    ...
    if 'roi_percent' not in holdings_df.columns and 'buy_price' in holdings_df.columns and 'current_price' in holdings_df.columns:
        holdings_df['roi_percent'] = ((holdings_df['current_price'] / holdings_df['buy_price']) - 1) * 100
